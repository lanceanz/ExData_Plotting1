...
# (5). Create png file for Plot 2.  The hex RGB value for the bar colour was taken from the example
png(filename = "plot2.png", width=480, height=480)
with(consump2, plot(Log_time, Global_active_power, type = "l", xlab = "", ylab="Global Active Power (kilowatts)" ))
dev.off()
